...
public extension PEPECSentence {
    static let allCases: [PEPECSentence] = [
        ...
        PEPECSentence(
            ...
            specialReading: "Hold south of Alpha Mike Sierra VOR at niner taosand feet, inbound track two seven zero degrees, left hand pattern, outbound time one minute. Expect further clearance at four six.",
            size: 90532,
            hasLotOfInfo: true
        ),
        PEPECSentence(
        ...
        PEPECSentence(
            ...
            specialReading: "Cleared to destination, flight planned route [raʊt], cruising level tree tree zero, departure Runway zero four, initial altitude seven taosand feet. Hotel Zulu zero one Departure, squawk two five six tree, departure frequency one two four decimal tree five.",
            size: 129193,
            hasLotOfInfo: true
        ),
        PEPECSentence(
        ...
        PEPECSentence(
            ...
            specialReading: "Cleared to destination via flight planned route [raʊt], Runway tree six right, Lima Kilo Oscar zero one Departure, initially climb to four taosand five hundred feet, cruising level tree one zero, when airborne contact one one niner decimal seven, squawk two five one five.",
            size: 126476,
            hasLotOfInfo: true
        ),
        PEPECSentence(
            ...
            specialReading: "Cleared via Zulu Foxtrot zero one Departure, initial altitude five taosand feet. Departure frequency one two five decimal niner. Cruising level two niner zero, departure Runway zero four. Squawk six five six tree.",
            size: 108295,
            hasLotOfInfo: true
        ),
        PEPECSentence(
            ...
            specialReading: "Cleared to destination via flight plan route [raʊt]. Departure Runway tree six left. Hotel Zulu zero one Delta Departure. Initial altitude five taosand feet. Cruising level tree tree zero. Departure frequency one one niner decimal four five, squawk five six six seven.",
            size: 139433,
            hasLotOfInfo: true
        ),
        PEPECSentence(
        ...
        PEPECSentence(
            ...
            specialReading: "Cleared to destination via flight planned route [raʊt], initial climb to two taosand seven hundred feet, request level change en-route, departure frequency one two zero decimal tree, squawk zero seven two two.",
            size: 90741,
            hasLotOfInfo: true
        ),
        PEPECSentence(
        ...
        PEPECSentence(
            ...
            specialReading: "Hold on the two six five radial of BravoKiloMike V-O-R between two five and three zero miles DME, flight-level one zero zero, inbound track zero eight five, right hand pattern, expected approach time one zero two two.",
            size: 94084,
            hasLotOfInfo: true
        ),
        PEPECSentence(
        ...
        PEPECSentence(
            ...
            specialReading: "Position four two North, one six five East at zero eight zero zero, flight-level tree niner zero.estimating four four North, one eight zero East at zero niner zero zero. four five North, one seven zero West next.",
            size: 119162,
            hasLotOfInfo: true
        ),
        PEPECSentence(
